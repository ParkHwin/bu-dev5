...
-- 게시글: entityuser의 id를 찾아 넣음 (스키마의 컬럼명은 snake_case)
INSERT INTO boards (category, content, created_at, title, userid)
...
-- 댓글(관리자 답변) - 해당 게시글이 있을 때만, 중복 방지 (컬럼명은 snake_case로 맞춤)
INSERT INTO comments (board_id, created_at, userid, content)
